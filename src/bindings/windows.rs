...
#[repr(C)]
pub struct sctp_sockstore {
    pub sin: __BindgenUnionField<sockaddr_in>,
    pub sin6: __BindgenUnionField<sockaddr_in6>,
    pub sconn: __BindgenUnionField<sockaddr_conn>,
    pub sa: __BindgenUnionField<sockaddr>,
...
fn bindgen_test_layout_sctp_send_failed_event() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_send_failed_event>())).ssfe_type as *const _ as usize
        },
        0usize,
        concat!(
        "Offset of field: ",
        stringify!(sctp_send_failed_event),
        "::",
        stringify!(ssfe_type)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_send_failed_event>())).ssfe_flags as *const _ as usize
        },
        2usize,
        concat!(
        "Offset of field: ",
        stringify!(sctp_send_failed_event),
        "::",
        stringify!(ssfe_flags)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_send_failed_event>())).ssfe_length as *const _ as usize
        },
        4usize,
        concat!(
        "Offset of field: ",
        stringify!(sctp_send_failed_event),
        "::",
        stringify!(ssfe_length)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_send_failed_event>())).ssfe_error as *const _ as usize
        },
        8usize,
        concat!(
        "Offset of field: ",
        stringify!(sctp_send_failed_event),
        "::",
        stringify!(ssfe_error)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_send_failed_event>())).ssfe_info as *const _ as usize
        },
        12usize,
        concat!(
        "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_send_failed_event>())).ssfe_assoc_id as *const _ as usize
        },
        28usize,
        concat!(
        "Offset of field: ",
        stringify!(sctp_send_failed_event),
        "::",
        stringify!(ssfe_assoc_id)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_send_failed_event>())).ssfe_data as *const _ as usize
        },
        32usize,
        concat!(
        "Offset of field: ",
...
fn bindgen_test_layout_sctp_notification() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<sctp_notification>())).sn_auth_event as *const _ as usize },
        0usize,
        concat!(
        "Offset of field: ",
        stringify!(sctp_notification),
        "::",
        stringify!(sn_auth_event)
        )
    );
    assert_eq!(
        unsafe {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_notification>())).sn_send_failed_event as *const _ as usize
        },
        0usize,
        concat!(
        "Offset of field: ",
        stringify!(sctp_notification),
        "::",
        stringify!(sn_send_failed_event)
        )
    );
    assert_eq!(
        unsafe {
...
fn bindgen_test_layout_sctp_hmacalgo() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<sctp_hmacalgo>())).shmac_number_of_idents as *const _ as usize
        },
        0usize,
        concat!(
        "Offset of field: ",
        ...
        "::",
        stringify!(shmac_number_of_idents)
        )
    );
    assert_eq!(
...
extern "C" {
    pub fn usrsctp_crc32c(arg1: *mut ::std::os::raw::c_void, arg2: size_t) -> u32;
}
extern "C" {
